...
namespace MongoMembership.Providers
{
    public class MongoProfileProvider : ProfileProvider
    {
        ...
        public override int DeleteProfiles(string[] usernames)
        {
            ...
            foreach (User user in usernames.Select(username => this.mongoGateway.GetByUserName(username)))
            {
        ...
        public override ProfileInfoCollection FindInactiveProfilesByUserName(ProfileAuthenticationOption authenticationOption, string usernameToMatch, DateTime userInactiveSinceDate, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            switch (authenticationOption)
            {
                case ProfileAuthenticationOption.Anonymous:
                    users = this.mongoGateway.GetInactiveAnonymSinceByUserName(usernameToMatch, userInactiveSinceDate, pageIndex, pageSize, out totalRecords);
                    break;
                case ProfileAuthenticationOption.Authenticated:
                case ProfileAuthenticationOption.All:
                    users = this.mongoGateway.GetInactiveSinceByUserName(usernameToMatch, userInactiveSinceDate, pageIndex, pageSize, out totalRecords);
                    break;
            }
        ...
        public override ProfileInfoCollection FindProfilesByUserName(ProfileAuthenticationOption authenticationOption, string usernameToMatch, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            {
                case ProfileAuthenticationOption.Anonymous:
                    users = this.mongoGateway.GetAllAnonymByUserName(usernameToMatch, pageIndex, pageSize, out totalRecords);
                    break;
                case ProfileAuthenticationOption.Authenticated:
                case ProfileAuthenticationOption.All:
                    users = this.mongoGateway.GetAllByUserName(usernameToMatch, pageIndex, pageSize, out totalRecords);
                    break;
            }
        ...
        public override ProfileInfoCollection GetAllInactiveProfiles(ProfileAuthenticationOption authenticationOption, DateTime userInactiveSinceDate, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            {
                case ProfileAuthenticationOption.Anonymous:
                    users = this.mongoGateway.GetAllInactiveAnonymSince(userInactiveSinceDate, pageIndex, pageSize, out totalRecords);
                    break;
                case ProfileAuthenticationOption.Authenticated:
                case ProfileAuthenticationOption.All:
                    users = this.mongoGateway.GetAllInactiveSince(userInactiveSinceDate, pageIndex, pageSize, out totalRecords);
                    break;
            }
        ...
        public override ProfileInfoCollection GetAllProfiles(ProfileAuthenticationOption authenticationOption, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            {
                case ProfileAuthenticationOption.Anonymous:
                    users = this.mongoGateway.GetAllAnonym(pageIndex, pageSize, out totalRecords);
                    break;
                case ProfileAuthenticationOption.Authenticated:
                case ProfileAuthenticationOption.All:
                    users = this.mongoGateway.GetAll(pageIndex, pageSize, out totalRecords);
                    break;
            }
        ...
        public override SettingsPropertyValueCollection GetPropertyValues(SettingsContext context, SettingsPropertyCollection collection)
        {
            ...
            User user = this.mongoGateway.GetByUserName(username);
        ...
        public override void SetPropertyValues(SettingsContext context, SettingsPropertyValueCollection collection)
        {
            ...
            var user = this.mongoGateway.GetByUserName(username)
                    ?? new User
                    {
