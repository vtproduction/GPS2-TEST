...
namespace MongoMembership.Providers
{
    public class MongoRoleProvider : RoleProvider
    {
        ...
        public override bool DeleteRole(string roleName, bool throwOnPopulatedRole)
        {
            ...
            this.mongoGateway.RemoveRole(roleName);
            return true;
        }
        ...
        public override string[] FindUsersInRole(string roleName, string usernameToMatch)
        {
            ...
            return this.mongoGateway.GetUsersInRole(roleName);
        }
        ...
        {
            return this.mongoGateway.GetRolesForUser(username);
        }
        ...
        {
            return this.mongoGateway.IsUserInRole(username, roleName);
        }
        ...
        {
            return this.mongoGateway.IsRoleExists(roleName);
        }
    }
}
