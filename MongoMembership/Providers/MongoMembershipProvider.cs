...
namespace MongoMembership.Providers
{
    public class MongoMembershipProvider : MembershipProvider
    {
        ...
        public override MembershipUserCollection FindUsersByEmail(string emailToMatch, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            var users = this.mongoGateway.GetAllByEmail(emailToMatch, pageIndex, pageSize, out totalRecords);
        ...
        {
            var membershipUsers = new MembershipUserCollection();
            var users = this.mongoGateway.GetAllByUserName(usernameToMatch, pageIndex, pageSize, out totalRecords);
        ...
        {
            var membershipUsers = new MembershipUserCollection();
            var users = this.mongoGateway.GetAll(pageIndex, pageSize, out totalRecords);
        ...
        public override int GetNumberOfUsersOnline()
        {
            ...
            return this.mongoGateway.GetUserForPeriodOfTime(timeSpan);
        }
        ...
        {
            var user = this.mongoGateway.GetByEmail(email);
